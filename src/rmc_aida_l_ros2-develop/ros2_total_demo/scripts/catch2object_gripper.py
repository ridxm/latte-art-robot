...
from rm_ros_interfaces.msg import Liftheight,Movejp,Armstate,Armoriginalstate,Gripperset
...
class CatchNode(Node):
    ...
    def worker_function(self):
        # 打开夹爪  手爪目标位置，范围：1～1000,代表手爪开口度：0～70mm
        ...
        moveJ_P_TargetPose.pose.position.y = y + 0.15
