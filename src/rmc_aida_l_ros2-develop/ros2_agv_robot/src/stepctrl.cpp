...
/// action.value: 1 -> execute
/// action.value: 2 -> pause
/// action.value: 3 -> Continue
/// mode.value: 1 -> go straight
/// mode.value: 2 -> rotate
/// mode.value: 3 -> traverse
/// mode.value: 4 -> tilt
/// speed: folat -> angular speed [rad/s]/linear speed [meter/s]
/// value: float -> Rotation arc/travel distance, positive forward and negative backward, positive and negative forward, positive left and negative right
/// angle: float -> Oblique movement angle, positive left and negative right
// clang-format on
