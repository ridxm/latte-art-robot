...
"""
# Save everything in data folder inside teleop directory
SAVE_DIRECTORY_PATH_DATA : str = os.path.join(os.path.dirname(os.path.abspath(__file__)), "data") + "/"
...
"""
DATA_FOLDER_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "data", "data")
