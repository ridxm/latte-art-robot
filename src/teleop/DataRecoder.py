...
class DataRecoder:
    def __init__(self, fps=30, slow_speed_threshold=15.0):
        ...
        self.episode_index = 0  # Start from episode 0
        self.index = 0
        self.dt = 1.0/fps
    ...
    def reset(self):
        ...
        self.column_index = 0
        self.timestamp = 0.0  # Reset to 0 for each episode
        # NOTE: frame_index and index are global counters - they do NOT reset per episode
    ...
    def _write_data_to_buffer_optimized(self, observation, action, reward, termination_flag, cam_data):
        ...
        # Update timestamp for next frame (increment by dt = 1/fps)
