...
bool rm_ros_interfaces__msg__gripperpick__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_ros_interfaces.msg._gripperpick.Gripperpick", full_classname_dest, 46) == 0);
  }
  rm_ros_interfaces__msg__Gripperpick * ros_message = _ros_message;
  {  // speed
  ...
  {  // force
    ...
    assert(PyLong_Check(field));
    ros_message->force = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // block
...
{
  /* NOTE(esteve): Call constructor of Gripperpick */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_ros_interfaces.msg._gripperpick");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Gripperpick");
