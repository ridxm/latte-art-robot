...
bool rm_ros_interfaces__msg__forcepositionmovejoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_ros_interfaces.msg._forcepositionmovejoint.Forcepositionmovejoint", full_classname_dest, 68) == 0);
  }
  rm_ros_interfaces__msg__Forcepositionmovejoint * ros_message = _ros_message;
  {  // joint
  ...
  {  // dir
    ...
    assert(PyLong_Check(field));
    ros_message->dir = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // force
...
{
  /* NOTE(esteve): Call constructor of Forcepositionmovejoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_ros_interfaces.msg._forcepositionmovejoint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Forcepositionmovejoint");
